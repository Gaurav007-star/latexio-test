...
const DashboardHeader = () => {
  ...
  return (
    <div className="navbar w-full h-max border-b-2 border-[#D9D9D9] px-10 py-5 flex items-center max-[1025px]:justify-between">
      {/* left part */}
      ...
      {/* middle part */}
      <div className="middle-part w-[40%] max-[1025px]:w-max h-max flex items-center justify-center gap-[10px] text-[18px] max-[500px]:gap-[6px] max-[500px]:text-[12px] max-[450px]:hidden">
      ...
      <div className="right-part w-[50%] max-[1025px]:w-max h-max flex items-center ">
        ...
        {/* desktop nav */}
        <div className="right-side w-full flex items-center justify-end gap-[20px] text-black max-[1025px]:hidden">
          <div className="dropdown dropdown-end">
            ...
            >
              <li>
                <a className="text-secondary text-[14px]">Item 1</a>
              </li>
              <li>
                <a className="text-secondary text-[14px]">Item 2</a>
              </li>
            </ul>
          </div>
        ...
        {/* menu section */}
        {userMenu &&
          <div className="user-profile-menu w-[150px] absolute translate-y-27 right-10 flex flex-col gap-[10px] rounded-md p-4 bg-white shadow-md text-[14px] max-[1025px]:text-[16px] text-black transition-transform duration-200 z-50 max-[1025px]:bottom-54 max-[1025px]:left-10">
            <button className="w-full h-[40px] rounded-md hover:bg-slate-200/70 cursor-pointer flex items-center justify-center gap-[6px] ">
              <IoSettingsOutline /> Setting
            </button>
            <button
              className="w-full h-[40px] rounded-md hover:bg-slate-200/70 cursor-pointer flex items-center justify-center gap-[6px] "
